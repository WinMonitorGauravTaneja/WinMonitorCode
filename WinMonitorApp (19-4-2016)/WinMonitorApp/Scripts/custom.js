                            ...
                            success: function (data) {
                                ...
                                for (i = 0; i < data.length; i++) {
                                    if (data[i].mstrIncidentName == null) {
                                        ...
                                        imageVariable = '<img src="http://cha-en-pdp1:6767/Content/Images/questionMark.jpg" id="' + data[i].mstrComponentId + '" style="height:20px;width:10px" onclick="showIncidentDetails()" class="questionMarkForIncident"/>';
