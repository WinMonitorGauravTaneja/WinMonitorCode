    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                newRow = '<tr style="background-color:rgb(255,255,250);"><td><input type="checkbox" value="' + data[i].mstrComponentId + '" name="ComponentListfromComponentPageCheckBoxes"></td><td>' + data[i].mstrComponentName +
